...
public class CRC {
	...
	public static long ComputeCRC16(byte[] buf, int nLen){
        WORDtoDBYTE crc = null, y = null;
        crc.w = 0;
        crc.l = 0;
        crc.h = 0;
        y.l = 0;
	...
	public static long ComputeCRC32(int[] buf, int nLen){
		CRC.WORDtoDBYTE crc = new CRC().new WORDtoDBYTE();
		CRC.WORDtoDBYTE y = new CRC().new WORDtoDBYTE();
        crc.w = 0L;
        crc.l = 0;
        crc.h = 0;
        y.l = 0;
